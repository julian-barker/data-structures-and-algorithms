...
const countNumberOfChildren = (arr) => {
  // Solution code here...
  return arr.reduce((a,b) => a + (Object.keys(b).includes('children') ? b.children.length : 0), 0);
  // return arr.reduce((a,b) => a + (b.children?.length || 0), 0);
};
...
const countPrimeNumbers = (arr) => {
  // Solution code here...
  return arr.reduce((a,b) => a + (isPrime(b) ? 1 : 0), 0);
};
...
const extractStat = (statName, arr) => {
  // Solution code here...
  return arr.reduce((a,b) => b.stat.name === statName ? b : a, null);
};
